...
=======
          <nav className="flex gap-4 mb-6">
            <button onClick={() => setActiveTab('overview')} className={`py-2 px-4 rounded ${activeTab === 'overview' ? 'bg-blue-700 text-white' : 'bg-zinc-800 text-zinc-300'}`}>Overview</button>
            <button onClick={() => setActiveTab('ai-chat')} className={`py-2 px-4 rounded ${activeTab === 'ai-chat' ? 'bg-blue-700 text-white' : 'bg-zinc-800 text-zinc-300'}`}>AI Chat</button>
            <button onClick={() => setActiveTab('screen-share')} className={`py-2 px-4 rounded ${activeTab === 'screen-share' ? 'bg-blue-700 text-white' : 'bg-zinc-800 text-zinc-300'}`}>Screen Share</button>
          </nav>
          {activeTab === 'overview' && (
            <section className="space-y-6">
>>>>>>> 00ada86 (Commit)
